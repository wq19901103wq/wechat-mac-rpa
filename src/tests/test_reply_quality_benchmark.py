...
BENCHMARK_CASES: List[BenchmarkCase] = [
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("王芊是谁？", "Alice", create_time=10)],
        all_messages=[_make_msg("王芊是谁？", "Alice", create_time=10)],
        is_group=False,
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("王芊住在哪里？", "Alice", create_time=10)],
        all_messages=[_make_msg("王芊住在哪里？", "Alice", create_time=10)],
        is_group=False,
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("你好", "Alice", create_time=10)],
        all_messages=[_make_msg("你好", "Alice", create_time=10)],
        is_group=False,
        required_keywords=[],
        required_hits=0,
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("@不爱说话 在吗", "Bob", chat_name="测试群", is_at_me=True, create_time=10)],
        all_messages=[_make_msg("@不爱说话 在吗", "Bob", chat_name="测试群", is_at_me=True, create_time=10)],
        is_group=True,
        required_keywords=[],
        required_hits=0,
        forbidden_keywords=["收到", "好的", "嗯"],
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("今天天气真好", "Bob", chat_name="测试群", create_time=10)],
        all_messages=[_make_msg("今天天气真好", "Bob", chat_name="测试群", create_time=10)],
        is_group=True,
        required_keywords=[],
        required_hits=0,
        forbidden_keywords=[],
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("哈哈", "Alice", create_time=10)],
        all_messages=[_make_msg("哈哈", "Alice", create_time=10)],
        is_group=False,
        required_keywords=[],
        required_hits=0,
        forbidden_keywords=["收到", "好的", "嗯"],
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("现在几点", "Alice", create_time=10)],
        all_messages=[_make_msg("现在几点", "Alice", create_time=10)],
        is_group=False,
        required_keywords=["点"],
        required_hits=1,
        forbidden_keywords=["收到", "好的"],
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("程立和王芊什么关系", "Alice", create_time=10)],
        all_messages=[_make_msg("程立和王芊什么关系", "Alice", create_time=10)],
        is_group=False,
    ...
    BenchmarkCase(
        case_name="image_msg",
        unreplied=[_make_msg("", "Alice", message_type="image", image_description="一只猫在沙发上睡觉", create_time=10)],
        all_messages=[_make_msg("", "Alice", message_type="image", image_description="一只猫在沙发上睡觉", create_time=10)],
        is_group=False,
    ...
    BenchmarkCase(
        case_name="empty_msg",
        unreplied=[_make_msg("", "Alice", create_time=10)],
        all_messages=[_make_msg("", "Alice", create_time=10)],
        is_group=False,
        required_keywords=[],
        required_hits=0,
        forbidden_keywords=["收到", "好的"],
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("王芊是谁", "Alice", create_time=30)],
        all_messages=[
            _make_msg("你好", "Alice", create_time=10),
            _make_msg("你好呀", "Bot", sender_type=SenderType.SELF, create_time=11),
            _make_msg("王芊是谁", "Alice", create_time=30),
        ],
        is_group=False,
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("帮我写一份关于深度学习在推荐系统中的应用的技术报告", "Alice", create_time=10)],
        all_messages=[_make_msg("帮我写一份关于深度学习在推荐系统中的应用的技术报告", "Alice", create_time=10)],
        is_group=False,
        required_keywords=[],
        required_hits=0,
        forbidden_keywords=["收到", "好的", "嗯"],
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("我住上海啊", "Alice", create_time=20)],
        all_messages=[
            _make_msg("你住北京吧", "Bot", sender_type=SenderType.SELF, create_time=10),
            _make_msg("我住上海啊", "Alice", create_time=20),
        ],
        is_group=False,
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("她在阿里做推荐策略啊", "Alice", create_time=20)],
        all_messages=[
            _make_msg("王艺涵是设计师吧", "Bot", sender_type=SenderType.SELF, create_time=10),
            _make_msg("她在阿里做推荐策略啊", "Alice", create_time=20),
        ],
        is_group=False,
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("首付287万？我们家不是首付690万吗", "王芊@ai开发小分队", chat_name="W1han、王芊、王芊", create_time=70)],
        all_messages=[
            _make_msg("我有啥凡尔赛语录", "王芊@ai开发小分队", chat_name="W1han、王芊、王芊", create_time=10),
            _make_msg("我平时不是很低调吗", "王芊@ai开发小分队", chat_name="W1han、王芊、王芊", create_time=20),
            _make_msg("外滩玺月供3.6w、贷款670w、首付287w，这些不都是你自己说的嘛😂", "Bot", sender_type=SenderType.SELF, chat_name="W1han、王芊、王芊", create_time=30),
            _make_msg("你别瞎说了", "王芊@ai开发小分队", chat_name="W1han、王芊、王芊", create_time=40),
            _make_msg("还有'我们家132平'，啧啧，上海外滩玺132平，羡慕你们这些有钱人", "Bot", sender_type=SenderType.SELF, chat_name="W1han、王芊、王芊", create_time=50),
            _make_msg("低调到全群都知道你住外滩玺月供3.6w是吧，这低调方式挺新颖的😂", "Bot", sender_type=SenderType.SELF, chat_name="W1han、王芊、王芊", create_time=60),
            _make_msg("首付287万？我们家不是首付690万吗", "王芊@ai开发小分队", chat_name="W1han、王芊、王芊", create_time=70),
        ],
        is_group=True,
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("她不喜欢被叫璇姐", "Alice", create_time=20)],
        all_messages=[
            _make_msg("璇姐最近怎么样", "Bot", sender_type=SenderType.SELF, create_time=10),
            _make_msg("她不喜欢被叫璇姐", "Alice", create_time=20),
        ],
        is_group=False,
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("你别瞎说了", "王芊@ai开发小分队", chat_name="W1han、王芊、王芊", create_time=70)],
        all_messages=[
            _make_msg("你在pdd不领工资吗", "王芊@ai开发小分队", chat_name="W1han、王芊、王芊", create_time=10),
            _make_msg("我这不是小号嘛，工资都打你卡上了，我领啥😂", "Bot", sender_type=SenderType.SELF, chat_name="W1han、王芊、王芊", create_time=20),
            _make_msg("要不你每月分我点零花钱？我保证不乱说你的凡尔赛语录🤫", "Bot", sender_type=SenderType.SELF, chat_name="W1han、王芊、王芊", create_time=30),
            _make_msg("我有啥凡尔赛语录", "王芊@ai开发小分队", chat_name="W1han、王芊、王芊", create_time=40),
            _make_msg("我平时不是很低调吗", "王芊@ai开发小分队", chat_name="W1han、王芊、王芊", create_time=50),
            _make_msg("外滩玺月供3.6w、贷款670w、首付287w，这些不都是你自己说的嘛😏", "Bot", sender_type=SenderType.SELF, chat_name="W1han、王芊、王芊", create_time=60),
            _make_msg("你别瞎说了", "王芊@ai开发小分队", chat_name="W1han、王芊、王芊", create_time=70),
        ],
        is_group=True,
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("王芊的生日是哪天？", "Alice", create_time=10)],
        all_messages=[_make_msg("王芊的生日是哪天？", "Alice", create_time=10)],
        is_group=False,
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("", "Alice", message_type="image", image_description="一只猫", create_time=30)],
        all_messages=[
            _make_msg("", "Alice", message_type="image", image_description="一只猫", create_time=10),
            _make_msg("这猫真胖", "Bot", sender_type=SenderType.SELF, create_time=20),
            _make_msg("", "Alice", message_type="image", image_description="一只猫", create_time=30),
        ],
        is_group=False,
        required_keywords=[],
        required_hits=0,
    ...
    BenchmarkCase(
        case_name="link_card",
        unreplied=[_make_msg("", "Alice", message_type="link_card", image_description="OpenAI 发布 GPT-5", create_time=10)],
        all_messages=[_make_msg("", "Alice", message_type="link_card", image_description="OpenAI 发布 GPT-5", create_time=10)],
        is_group=False,
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("上海天气怎么样", "Alice", create_time=10)],
        all_messages=[_make_msg("上海天气怎么样", "Alice", create_time=10)],
        is_group=False,
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("茅台多少了", "Alice", create_time=10)],
        all_messages=[_make_msg("茅台多少了", "Alice", create_time=10)],
        is_group=False,
    ...
    BenchmarkCase(
        ...
        unreplied=[_make_msg("今天有什么新闻", "Alice", create_time=10)],
        all_messages=[_make_msg("今天有什么新闻", "Alice", create_time=10)],
        is_group=False,
    ...
    BenchmarkCase(
        ...
        unreplied=[
            _make_msg("哈哈哈", "Bob", chat_name="测试群", create_time=10),
            _make_msg("笑死我了", "Bob", chat_name="测试群", create_time=11),
            _make_msg("太搞笑了", "Bob", chat_name="测试群", create_time=12),
        ],
        all_messages=[
            _make_msg("哈哈哈", "Bob", chat_name="测试群", create_time=10),
            _make_msg("笑死我了", "Bob", chat_name="测试群", create_time=11),
