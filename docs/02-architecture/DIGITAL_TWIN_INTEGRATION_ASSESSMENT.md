...
| 决策点 | 方案 |
|--------|------|
| 系统 prompt | **以 digital-twin 为准**（"你是示例用户甲本人"），融合 wechat-mac-rpa 的工具调用 |
...
```
你是示例用户甲本人。用户不是在跟AI聊天，是在微信上给示例用户甲发消息。
