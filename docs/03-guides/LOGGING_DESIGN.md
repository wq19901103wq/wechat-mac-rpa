...
#### `messages`
```json
{"ts":"2026-04-15T09:12:35.234567","event":"messages","tick_id":42,"total_messages":6,"new_messages":1,"message_details":[{"text":"在吗","sender":"示例用户酉","sender_type":"other","is_at_me":false}]}
```
